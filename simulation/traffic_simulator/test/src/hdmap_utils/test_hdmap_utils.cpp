...
{
  const auto lanelet_map_ptr = traffic_simulator::lanelet_wrapper::LaneletLoader::load(
    ament_index_cpp::get_package_share_directory("traffic_simulator") +
    "/map/standard_map/lanelet2_map.osm");
  ASSERT_NO_THROW(
    traffic_simulator::lanelet_wrapper::LaneletLoader::convertMapToBin(lanelet_map_ptr));
}
